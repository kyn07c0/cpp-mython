...
namespace parse {
    ...
    public:
        ...
        const T& Expect() const {
            ...
            throw LexerError("Type token is not correct"s);
        }
        ...
        void Expect(const U& value) const {
            ...
            {
                throw LexerError("Type token holds a different value"s);
            }
        }
    ...
    private:
        ...
        void ProcEndOfLine();
        void ProcIndent();
        void ProcNumber(char cur_char);
        void ProcWord(char cur_char);
        void ProcShielding(char cur_char);
        void ProcComment();
